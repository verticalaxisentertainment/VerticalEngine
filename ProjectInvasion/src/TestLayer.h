...
public:
	...
	void OnUpdate() override
	{
		...
		Renderer::BeginScene();
			Renderer::DrawQuad({ 1.55f,0.9f,0.5f }, { 0.5f,0.2f }, { 0.0f,0.7f,0.0f,0.5f });
		...
		else if((pixelData[3] == 1 && pixelData[1] == 0))
		{
			app.GetWindow().SetCursor(Cursor::HAND);
		}
		else
...
private:
	float* pixelData;
	glm::vec4 m_ColorBox= { 0.0f,0.0f,1.0f,1.0f }, m_ColorCircle= { 1.0f,0.0f,0.0f,1.0f };
	float m_x, m_y;
	...
	bool onMouseReleased(MouseButtonReleasedEvent& e)
	{
		if(e.GetMouseButton()==Mouse::Button0)
		{
			m_ColorBox = { 0.0f,0.0f,1.0f,1.0f };
			m_ColorCircle = { 1.0f,0.0f,0.0f,1.0f };
		}
		return false;
	}
};